...
const MODULE_ID = 'ninjos-foundry-mcp';
...
const MODUL = {
  ...
  slug: 'foundry-mcp',
  untertitel: 'MCP.Willkommen.Untertitel',
  einleitung: 'MCP.Willkommen.Einleitung',
  punkte: ['MCP.Willkommen.Punkt1', 'MCP.Willkommen.Punkt2', 'MCP.Willkommen.Punkt3'],
...
export async function willkommenZeigen() {
    ...
    <div class="ninjo-willkommen">
      ...
      <a class="ninjo-willkommen-forge" href="${forgeAdresse()}" target="_blank" rel="noopener">
        ...
        <span class="ninjo-willkommen-forge-text">
          ...
          <span class="ninjo-willkommen-forge-zeile">${text('MCP.Willkommen.ForgeZeile')}</span>
        </span>
  ...
  const antwort = await foundry.applications.api.DialogV2.wait({
    ...
    buttons: [
      {
        action: 'nie',
        label: 'MCP.Willkommen.Nie',
        icon: 'fa-solid fa-check',
        default: true,
      },
      {
        action: 'spaeter',
        label: 'MCP.Willkommen.Spaeter',
